...
/** catalog.LibraryCatalog Class - represents a collection of books,
...
public class LibraryCatalog {
    ...
    /**
     * Constructor for catalog.LibraryCatalog
     */
     ...
     * @return reference to the catalog.Book with the given title
     */
     ...
     * checks it out (by calling the corresponding method in class catalog.Book)
     ...
     * calling the returnBook() method of class catalog.Book.
     ...
     * creates a catalog.Book object, and adds it to the ArrayList of books.
     *
     ...
     * toString method in class catalog.Book.
