...
/** A class for testing methods in class catalog.LibraryCatalog */
public class LibraryCatalogTester {
    ...
    /** Tests toString method of class catalog.LibraryCatalog */
    @Test
    ...
    /** Tests findBook method of class catalog.LibraryCatalog.
    ...
    /** Tests checkoutBook method of class catalog.LibraryCatalog.
    ...
    /** Tests checkoutBook method of class catalog.LibraryCatalog, checks
    ...
    /** Tests returnBook of class catalog.LibraryCatalog, makes sure that when
    ...
    public void testAddBooksFromFile() {
        ...
        assertTrue("After loading books from books5.csv, the result returned by toString method of catalog.LibraryCatalog does not match the expected result", studentResult.equals(expectedResult));
    }
